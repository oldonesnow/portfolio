...
export default function Skills() {
  return (
    <SectionWrapper id="skills" className="bg-base">
      <div className="mb-12">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {group.items.map((skill) => (
                <span
                  key={skill}
                  className="font-mono text-sm px-3 py-1.5 bg-white border border-gray-200 text-charcoal rounded hover:border-accent hover:text-accent transition-colors duration-200"
                >
                  {skill}
                </span>
              ))}
